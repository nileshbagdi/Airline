...
export class SeatbookingComponent implements OnInit {
  ...
  seatbooking:ISeatbooking={
    ...
    constructor(private seatbookingservice:SeatbookingServiceService,private router:Router,private route:ActivatedRoute) { }
  
    AddBooking(){
      this.seatbookingservice.AddBooking(this.seatbooking.PassengerID,this.seatbooking.FlightID,this.seatbooking).subscribe(
        ()=>{
          alert("Record Added");
    ...
    saveSeatbooking(seatbooking:ISeatbooking):void{
      this.AddBooking();
    }
